...
<div id="subPageBox">
	...
	<%
	arrListHeader = array("구분","제목","대상","전송요청일시","상태","상세보기")
...
<script>
	...
	function fnLoadPage(p){
		...
		var param = 'proc=CallResult&param=W]|[<%=ss_userIdx%>]|['+clMethod+']|['+clStep+']|[0]|[0]|[0]|['+$('#schSDate').val()+']|['+$('#schEDate').val()+']|['+$('#schKey').val()+']|['+$('#schVal').val()+'&page='+page+'&pageSize='+pageSize;
	...
	function fnDetailView(idx){
		layerW = 1000;
		layerH = 800;
		var url = 'pop_resultView.asp?gb=E&clIdx='+idx;
