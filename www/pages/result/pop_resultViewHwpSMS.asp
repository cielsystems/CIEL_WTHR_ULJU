...
%>
<table border="0"><tr><td colspan="6"><h1>문자전송 결과 보고서</h1></td></tr></table>
<br />
<table border="1">
	<tr>
		<th>발령코드</th>
...
<table border="1">
	...
	<tr>
		...
		<td colspan="2"><%=formatNumber(cntSMSAll,0)%></td>
		<td><%=formatNumber(cntSMSStay,0)%></td>
		<td><%=formatNumber(cntSMSIng,0)%></td>
