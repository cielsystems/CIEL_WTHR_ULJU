...
sql = sql & " 	, (select count(*) from TBL_CALLTRG_VMS with(nolock) where CL_IDX = " & clIdx & ") as CNTSMSALL "
sql = sql & " 	, (select count(*) from TBL_CALLTRG_VMS with(nolock) where CL_IDX = " & clIdx & " and CD_STATUS < 3032) as CNTSMSSTAY "
sql = sql & " 	, (select count(*) from TBL_CALLTRG_VMS with(nolock) where CL_IDX = " & clIdx & " and CD_STATUS = 3032) as CNTSMSING "
sql = sql & " 	, (select count(*) from TBL_CALLTRG_VMS with(nolock) where CL_IDX = " & clIdx & " and CD_STATUS = 3033) as CNTSMSCMP "
sql = sql & " 	, (select count(*) from TBL_CALLTRG_VMS with(nolock) where CL_IDX = " & clIdx & " and CD_STATUS = 3034) as CNTSMSCNL "
sql = sql & " 	, (select count(*) from TBL_CALLTRG_VMS with(nolock) where CL_IDX = " & clIdx & " and CD_STATUS = 3035) as CNTSMSERR "
