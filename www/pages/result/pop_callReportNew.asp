			...
			<tr>
				<td style="padding:0 2px;">
					...
					<table border="1" cellpadding="0" cellspacing="0" class="tblPrint">
						...
						<tr>
							<td><%=formatNumber(cntVMSAll,0)%></td>
							<td><%=formatNumber(cntVMSAnsw,0)%></td>
							<td><%=formatNumber(cntVMSAll - cntVMSAnsw,0)%></td>
							<td><%=formatNumber(cntVMSStay + cntVMSIng,0)%></td>
							
							<td><%=formatNumber(cntSMSAll,0)%></td>
							<td><%=formatNumber(cntSMSCmp,0)%></td>
							<td><%=formatNumber(cntSMSErr,0)%></td>
							<td><%=formatNumber(cntSMSCnl,0)%></td>
						</tr>
					</table>
											...
											<tr>
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barBlue">
														<tr><td class="non" style="height:<%=(100-fnPer(cntVMSAll,cntVMSAnsw))*2%>px;">&nbsp;</td></tr>
														<tr><td class="bar" style="height:<%=fnPer(cntVMSAll,cntVMSAnsw)*2%>px;">&nbsp;</td></tr>
														<tr><td class="txt">응답<br>(<%=fnPer(cntVMSAll,cntVMSAnsw)%>%)</td></tr>
													</table>
												</td>
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barRed">
														<tr><td class="non" style="height:<%=(100-fnPer(cntVMSAll,cntVMSAll - cntVMSAnsw))*2%>px;">&nbsp;</td></tr>
														<tr><td class="bar" style="height:<%=fnPer(cntVMSAll,cntVMSAll - cntVMSAnsw)*2%>px;">&nbsp;</td></tr>
														<tr><td class="txt">미응답<br>(<%=fnPer(cntVMSAll,cntVMSAll - cntVMSAnsw)%>%)</td></tr>
													</table>
												</td>
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barGray">
														<tr><td class="non" style="height:<%=(100-fnPer(cntVMSAll,cntVMSStay + cntVMSIng))*2%>px;">&nbsp;</td></tr>
														<tr><td class="bar" style="height:<%=fnPer(cntVMSAll,cntVMSStay + cntVMSIng)*2%>px;">&nbsp;</td></tr>
														<tr><td class="txt">미처리<br>(<%=fnPer(cntVMSAll,cntVMSStay + cntVMSIng)%>%)</td></tr>
													</table>
												</td>
											</tr>
										</table>
									...
									<div class="grp">
										<table border="0" cellpadding="0" cellspacing="0" style="margin-top:30px;margin-bottom:30px;">
											<tr>
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barBlue">
														<tr><td class="non" style="height:<%=(100-fnPer(cntSMSAll,cntSMSAll))*2%>px;">&nbsp;</td></tr>
														<tr><td class="bar" style="height:<%=fnPer(cntSMSAll,cntSMSAll)*2%>px;">&nbsp;</td></tr>
														<tr><td class="txt">전송<br>(<%=fnPer(cntSMSAll,cntSMSAll)%>%)</td></tr>
													</table>
												</td>
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barGreen">
												...
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barRef">
														<tr><td class="non" style="height:<%=(100-fnPer(cntSMSAll,cntSMSErr))*2%>px;">&nbsp;</td></tr>
														<tr><td class="bar" style="height:<%=fnPer(cntSMSAll,cntSMSErr)*2%>px;">&nbsp;</td></tr>
														<tr><td class="txt">실패<br>(<%=fnPer(cntSMSAll,cntSMSErr)%>%)</td></tr>
													</table>
												</td>
												<td valign="bottom">
													<table border="0" cellpadding="01" cellspacing="0" class="grpBar barGray">
														<tr><td class="non" style="height:<%=(100-fnPer(cntSMSAll,cntSMSCnl))*2%>px;">&nbsp;</td></tr>
														<tr><td class="bar" style="height:<%=fnPer(cntSMSAll,cntSMSCnl)*2%>px;">&nbsp;</td></tr>
														<tr><td class="txt">취소<br>(<%=fnPer(cntSMSAll,cntSMSCnl)%>%)</td></tr>
													</table>
												</td>
											</tr>
										</table>
