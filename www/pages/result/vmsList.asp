...
<div id="subPageBox">
	...
	<%
	arrListHeader = array("제목","대상","전송요청일시","상태","상세보기")
	arrListWidth = array("*","100px","160px","80px","100px")
...
<script>
	...
	function fnLoadPage(p){
		...
		var param = 'proc=CallResult&param=V]|[<%=ss_userIdx%>]|['+clMethod+']|['+clStep+']|[0]|[0]|[0]|['+$('#schSDate').val()+']|['+$('#schEDate').val()+']|['+$('#schKey').val()+']|['+$('#schVal').val()+'&page='+page+'&pageSize='+pageSize;
	...
	function fnDetailView(idx){
		layerW = 1000;
		layerH = 700;
		var url = 'pop_resultView.asp?gb=V&clIdx='+idx;
