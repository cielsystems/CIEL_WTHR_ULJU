...
arrRs = fnDBRs("TMP_CALLTRG","TMP_NO, TMP_IDX, TMP_NM, TMP_NUM1","AD_IDX = " & ss_userIdx & " and AD_IP = '" & svr_remoteAddr & "'")
%>
...
<div id="trgListBox" style="background:#eee;color:#333;">
	<dl id="trgList">
		...
		if isarray(arrRs) then
			...
			for i = 0 to arrRc2
				response.write	"<dt>" & fnCutStr(arrRs(2,i),6) &"&nbsp;</dt><dd class=""num"">" & arrRs(3,i) & "</dd><dd class=""btn""><img class=""imgBtn"" onclick=""fnSelNumDel('" & arrRs(0,i) & "', '" & arrRs(3,i) & "')"" src=""" & pth_pubImg & "/icons/cross.png"" /></dd>"
			next
		else
			arrRc2 = -1
		end if
