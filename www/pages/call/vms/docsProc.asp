...
if proc = "add" then
	...
	call execProc("usp_setMsg", array("I", 0, "N", 200302, "N", 0, "", tit, "", msg, "", ss_userIdx, svr_remoteAddr))
...
elseif proc = "del" then
	...
	call execProc("usp_setMsg", array("D", idx, "N", 200302, "N", 0, "", tit, "", msg, "", ss_userIdx, svr_remoteAddr))
