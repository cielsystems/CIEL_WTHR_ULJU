			...
			<div class="tree_box" style="height:400px;">
				...
				for i = 0 to ubound(arrGrupGubn)
					...
					with cmd
						...
						.commandtext = "nusp_listGrupTreeNoti"
					...
					for grupLoop = 0 to grupRc
						...
						response.write	"				<input type=""hidden"" name=""grupAddr"" value=""" & grupRs(14, grupLoop) & """ />"
						...
						if grupRs(14, grupLoop) > 0 then
							response.write	" <span class=""btn_radius bg_teal pdT01 pdR03 pdB01 pdL03 fnt11"">" & grupRs(14, grupLoop) & "</span>"
						end if
						response.write	"				</label>"
						response.write	"			</span>"
