...
<div id="subPageBox">
	...
	<%
	arrListHeader = array("제목","구분","발신자","대상","전송요청일시","상태","상세보기","삭제")
	arrListWidth = array("*","60px","100px","80px","160px","80px","100px","60px")
...
<script>
	...
	function fnLoadPage(p){
		...
		var param = 'proc=CallResult&param=S]|[0]|['+clMethod+']|['+clStep+']|[0]|[0]|[0]|['+$('#schSDate').val()+']|['+$('#schEDate').val()+']|['+$('#schKey').val()+']|['+$('#schVal').val()+'&page='+page+'&pageSize='+pageSize;
	...
	function fnDetailView(idx){
		layerW = 1000;
		layerH = 700;
		var url = '/pages/result/pop_resultView.asp?gb=S&clIdx='+idx;
